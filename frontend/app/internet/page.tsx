  ...
  return (
    <main className="min-h-screen pb-10">
      ...
      <div className="mx-auto mt-6 w-full max-w-6xl space-y-5 px-4 md:px-6">
        ...
        >
          <div className="min-w-0 rounded-lg border border-sky-200 bg-white px-1.5 py-1.5 text-[12px] leading-[14px] text-sky-950 md:px-3 md:py-2 md:text-sm">Kas<br /><b className={stickyValueClass(internetKas)}>{formatRupiah(internetKas)}</b></div>
